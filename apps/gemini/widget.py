...
class Chat(QtWidgets.QWidget):
    ...
    def __init__(self, parent: QtWidgets.QWidget | None = None):
        ...
        self._message.setPlaceholderText("Type query here and press Ctrl+Enter to send.")
        ...
        self._send   = self._options.addAction(qta.icon('ph.paper-plane-right-fill', color='#ffa300'), "Send Message")

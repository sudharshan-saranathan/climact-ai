...
from PySide6.QtGui import QFont, QColor, QTextCursor, QShortcut, QKeySequence, QCursor, QPen
...
class Label(QGraphicsTextItem):
    ...
    def __init__(self, label: str, parent: QGraphicsItem | None = None, **kwargs):
        ...
        # Like all other QGraphicsObjects, make the center of the textbox the origin:
    ...
    def paint(self, painter, option, widget):
        ...
        painter.drawRoundedRect(self.boundingRect().adjusted(0, 2, 0, -2), self.property("round"), self.property("round"))
